...
## 中文说明
此技能来自 GitHub 高星开源项目 [f/prompts.chat](https://github.com/f/prompts.chat)（⭐165,462），让 AI 扮演「Cinematic Ink & Color Illustration Generator — Gary Frank Style」角色，按照提示词中的指令进行交互。
